...
##################################################
#
# cr_use_bc_Y1Y2 constructs a dataset of credit-card balances
...
df_acct = sqlContext.read.parquet("/appdata/TU/TU_Official/Account/account_20{1[8-9],20}-*-01_parq") \
  ...
  .where("PRODUCT_TYPE LIKE 'BC'").where("Run_date <= DATE('2020-01-01')")
...
# at origination of credit card account
###########################################################
...
df_acct.printSchema()
df_acct.write.parquet(path="df_acct_1819.parquet", mode="overwrite")
