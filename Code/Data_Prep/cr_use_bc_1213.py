...
df_acct = sqlContext.read.parquet("/appdata/TU/TU_Official/Account/account_201[2-4]-*-01_parq") \
  ...
  .where("PRODUCT_TYPE LIKE 'BC'").where("Run_date <= DATE('2014-01-01')")
...
df_acct.printSchema()
df_acct.write.parquet(path="df_acct_1213.parquet", mode="overwrite")
