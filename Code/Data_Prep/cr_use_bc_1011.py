...
df_acct = sqlContext.read.parquet("/appdata/TU/TU_Official/Account/account_201[0-2]-*-01_parq") \
  ...
  .where("PRODUCT_TYPE LIKE 'BC'").where("Run_date <= DATE('2012-01-01')")
...
df_acct.printSchema()
df_acct.write.parquet(path="df_acct_1011.parquet", mode="overwrite")
