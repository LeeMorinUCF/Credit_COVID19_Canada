...
##################################################
#
# COVID_CJE_Cards_AB_prelim is an analysis of credit-card balances.
...
#--------------------------------------------------
# Smoothed surface of transition density.
#--------------------------------------------------
