...
##################################################
#
# COVID_CJE_AB_Cards_estim is an analysis of credit-card balances.
...
#
# Dependencies:
#   Data loading and preparation in COVID_CJE_AB_Cards.R
#
#
##################################################
...
post_crisis_dates <- as.character(unique(tu[post_crisis == TRUE, time]))
...
#--------------------------------------------------
# Start from Beginning of Post-Crisis Period
#--------------------------------------------------
...
forecast_date_labels <- unique(tu[post_crisis == TRUE, stmt_date])
